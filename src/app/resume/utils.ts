...
export function validateFrontmatter(
  ...
  if (requireAllFields && (!frontmatter.name || !frontmatter.github || !frontmatter.email)) {
...
export function createConfigWithFrontmatter(config: Config, frontmatter: Frontmatter): Config {
  return {
    ...config,
    variables: {
      frontmatter,
